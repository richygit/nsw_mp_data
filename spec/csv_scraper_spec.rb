...
describe CsvScraper do
  ...
  AJAKA_RECORD = {"type"=>"senator", "surname"=>"Ajaka", "email"=>"office@ajaka.minister.nsw.gov.au", "office_address"=>"Parliament House Macquarie Street", "office_suburb"=>"Sydney", "office_postcode"=>"2000", "office_state"=>"NSW", "office_fax"=>"(02) 9230 3620", "office_phone"=>"(02) 9230 3640", "party"=>"Liberal Party", "electorate"=>nil, "ministerial_office_phone"=>"(02) 8574 6400"}

  PENRITH_RECORD = {"type"=>"mp", "surname"=>"Ayres", "email"=>"penrith@parliament.nsw.gov.au", "office_address"=>"Shop 23 Ground Floor Penrith Centre 510-534 High Street", "office_suburb"=>"PENRITH", "office_postcode"=>"2750", "office_state"=>"NSW", "office_fax"=>"(02) 4731 4782", "office_phone"=>"(02) 4722 8660", "party"=>"Liberal Party", "electorate"=>"Penrith", "ministerial_office_phone"=>"(02) 8574 6500"}

  CESSNOCK_RECORD = {"type"=>"mp", "surname"=>"Barr", "email"=>"cessnock@parliament.nsw.gov.au", "office_address"=>"118 Vincent Street", "office_suburb"=>"CESSNOCK", "office_postcode"=>"2325", "office_state"=>"NSW", "office_fax"=>"(02) 4991 1103", "office_phone"=>"(02) 4991 1466", "party"=>"Australian Labor Party", "electorate"=>"Cessnock", "ministerial_office_phone"=>nil}
end
